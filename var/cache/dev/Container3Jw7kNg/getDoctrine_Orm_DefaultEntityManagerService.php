...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\CategoriesRepository' => function () {
    return ($this->privates['App\Repository\CategoriesRepository'] ?? $this->load('getCategoriesRepositoryService.php'));
}, 'App\\Repository\\MessagesRepository' => function () {
    return ($this->privates['App\Repository\MessagesRepository'] ?? $this->load('getMessagesRepositoryService.php'));
}, 'App\\Repository\\OrderDetailRepository' => function () {
