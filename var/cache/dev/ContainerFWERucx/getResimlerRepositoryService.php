...
// Returns the private 'App\Repository\ResimlerRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ResimlerRepository.php';

return $this->privates['App\Repository\ResimlerRepository'] = new \App\Repository\ResimlerRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
